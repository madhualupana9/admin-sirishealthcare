<!-- resources/views/livewire/sub-branch-hospitals/create.blade.php -->
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden transition-slow hover:shadow-2xl">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-5 sm:px-8">
                <div class="flex flex-col sm:flex-row justify-between items-center">
                    <div>
                        <h2 class="text-2xl font-bold text-white">Sub Branch Hospital Information</h2>
                ...
                <form wire:submit.prevent="save" class="space-y-8">
                    ...
                    <div class="pt-6 flex justify-end">
                        <button type="submit"
                            ...
                            <span wire:loading.remove>Create Sub Branch Hospital</span>
